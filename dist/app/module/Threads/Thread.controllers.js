...
exports.getMessages = exports.addMessage = exports.getThreads = exports.createThread = void 0;
...
exports.addMessage = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const message = yield ThreadService.addMessage(threadId, authorId, content, type);
